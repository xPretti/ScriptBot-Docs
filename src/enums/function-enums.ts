...
> = {
   ...
   [ENUM_FUNCTION_CATEGORY_TYPE.CANDLES]: () => "Candles",
   [ENUM_FUNCTION_CATEGORY_TYPE.DEBUGS]: () => "Depuradores",
   ...
   [ENUM_FUNCTION_CATEGORY_TYPE.TRADES]: () => "Negociações abertas",
   [ENUM_FUNCTION_CATEGORY_TYPE.DEALS]: () => "Negociações fechadas",
};
