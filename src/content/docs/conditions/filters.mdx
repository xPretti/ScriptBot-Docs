...
Os filtros são acionados automaticamente após o [Gatilho de Confirmação](/conditions/triggers), iniciando a análise para autorizar ou não a entrada no mercado.
