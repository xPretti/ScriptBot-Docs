...
sidebar:
   order: 0
description: "Esta página apresenta os fragmentos disponíveis no ScriptBot, explica sua finalidade e funcionamento, e demonstra como eles facilitam automatizações e aceleram o desenvolvimento de estratégias de forma prática e eficiente."
---
