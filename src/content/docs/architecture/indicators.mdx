...
tableOfContents:
   minHeadingLevel: 2
   maxHeadingLevel: 4
description: "Esta página apresenta os indicadores como ferramentas essenciais para a tomada de decisão, explica suas formas de aplicação no ScriptBot e destaca sua importância na criação de filtros, entradas mais precisas e análises avançadas."
---
...
- **Indicadores internos**
   ...
   - Você pode consultar a lista completa acessando: <BaseLink href="/references/indicators/">Lista de Indicadores</BaseLink>
...
<Spoiler title="Indicadores Internos">
   <Steps>
      1. A instalação de um indicador interno é extremamente simples.  
         O primeiro passo é escolher um indicador na <BaseLink href="/references/indicators/">Lista de Indicadores</BaseLink>.  
      2. Com o indicador escolhido, basta adicioná-lo na configuração do robô.
         ...
         No exemplo acima, o indicador <BaseLink href="/references/indicators/#alligator">Alligator</BaseLink> foi adicionado na configuração do robô.
...
<Preview title="Entendendo os Parâmetros:"> 
   <FreeMark>
      0, SYMBOL, CURRENT
      |    |        |-\> Período de Análise: <BaseLink href="/references/enumerators/#timeframes">Lista de Períodos</BaseLink>
      |    |----------\> Tipo de Ativo: <BaseLink href="/references/constants/#symbols">Lista de Ativos</BaseLink>
      |---------------\> Janela de Análise: <BaseLink href="/references/constants/#windows">Lista de Janelas</BaseLink>
   </FreeMark>
</Preview>
...
<Preview title="Entendendo os Parâmetros:"> 
   <FreeMark>
      ...
      |   |  |  |  |  |      |        |-> Applied price: <BaseLink href="/references/enumerators/#prices">Lista de Preços</BaseLink>
      |   |  |  |  |  |      |----------> Moving average method: <BaseLink href="/references/enumerators/#methods">Lista de Metodos</BaseLink>
      |   |  |  |  |  |-----------------> Lips shift
      |   |  |  |  |--------------------> Lips period
      |   |  |  |-----------------------> Teeth shift
      |   |  |--------------------------> Teeth period
...
Para utilizar os <BaseLink href="/architecture/fragments">Fragmentos</BaseLink> em um arquivo .set, é necessário abrir o arquivo .set. Nele, você pode alterar os valores e substituir pelos nomes dos fragmentos.  
