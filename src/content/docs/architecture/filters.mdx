...
sidebar:
   order: 0
description: "Esta página apresenta informações sobre os filtros, explica sua finalidade e mostra como eles ajudam a aumentar a confiabilidade das estratégias no ScriptBot."
---
...
Os filtros são acionados automaticamente após o <BaseLink href="/architecture/triggers">Gatilho de Confirmação</BaseLink>, iniciando a análise para autorizar ou não a entrada no mercado.
