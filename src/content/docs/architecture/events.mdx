...
sidebar:
   ...
   badge:
      text: Beta
      variant: caution
description: "Esta página apresenta informações sobre os eventos, explica sua finalidade e demonstra como utilizá-los na criação de estratégias no ScriptBot."
---
...
- **[01] - Tipo**: Define o tipo do evento que será ouvido. Acesse a <BaseLink href="/references/events/">Lista de Eventos</BaseLink>
