...
sidebar:
   order: 0
description: "Esta página apresenta os operadores disponíveis no ScriptBot, explica seu papel em operações matemáticas, lógicas e estruturais, e destaca sua importância na criação de condições, cálculos e controle de fluxo em scripts."
---
